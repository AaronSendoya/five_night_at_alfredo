...
// Coordenadas donde quieres el icono (ej. Esquina inferior derecha)
var _icon_x = display_get_gui_width() - 50; 
var _icon_y = display_get_gui_height() - 80;

if (global.has_fuse) {
    // Dibuja el icono del fusible (usa el sprite grande/vertical aquí)
    // Asumiendo que tienes un sprite 'spr_fusible_ui' o usa el mismo 'spr_fusible'
    // Asegúrate de escalar si es muy grande
    
    draw_sprite_ext(sp_fusible_1, 0, _icon_x, _icon_y, 2, 2, 0, c_white, 1);
    
    // Texto opcional
    draw_set_halign(fa_center);
    draw_text(_icon_x, _icon_y + 40, "FUSIBLE");
    draw_set_halign(fa_left);
}